...
public class PanelEditarRestaurante extends JPanel
{
    ...
    public PanelEditarRestaurante( )
    {
        ...
        // TODO completar
    	JLabel labelVisitado = new JLabel("Este restaurante ya fue visitado");
    	String [] op = {"Si", "No"};
    	cbbVisitado=new JComboBox<>(op);
    	add(labelVisitado);
    	add(cbbVisitado);
    ...
    {
        // TODO completar
    	String sele = (String) cbbVisitado.getSelectedItem();
        return sele.equals("Si");
    }
