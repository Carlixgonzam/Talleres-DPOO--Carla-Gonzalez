...
public class GeneradorTiquetes {
	private Tiquete builds;
	public GeneradorTiquetes(Tiquete builds) {
    ...
    {
        // TODO implementar
    	String codig = unTiquete.getCodigo();
    	codigos.add(codig);
    ...
    {
        // TODO implementar
    	boolean yaesta = codigos.contains(codigoTiquete);
    	
        return yaesta;
    }

	public Tiquete getBuilds() {
		return builds;
	}

	public void setBuilds(Tiquete builds) {
		this.builds = builds;
	}
