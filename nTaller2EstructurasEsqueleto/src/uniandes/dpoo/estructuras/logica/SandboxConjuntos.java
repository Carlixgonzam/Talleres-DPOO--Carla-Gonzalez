...
public class SandboxConjuntos
{
    ...
    {
    	if(!arbolCadenas.isEmpty()) {
    		arbolCadenas.pollFirst(); //elimino la primera cadena
    	}
    }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
        ...
        for (Object ob : objetos) {
            arbolCadenas.add(ob.toString()); //convierto a String 
        }
    }
    ...
    {
    	return new TreeSet<>(arbolCadenas.descendingSet()); //mayor a menor
    }
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
    	for (String cadena : otroArreglo) {
            if (!arbolCadenas.contains(cadena)) { //se comparan los elementos contenidos en el otro arreglo
                return false; 
            }
        }
        return true;
